  ...
  return (
    <FiltersStyle>
      <div className="selectsFilter">
        <select
          onChange={(e) =>
            dispatch({ type: "orderBy", orderBy: e.target.value })
          }
          name="orderBy"
          id="orderBy"
        >
        ...
        <select
          onChange={(e) => dispatch({ type: "limit", limit: e.target.value })}
          name="limit"
          id="limit"
        >
        ...
        <div className="buttonDiv">
          <button
            onClick={() => dispatch({ type: "listStyle", listStyle: "box" })}
            className={listStyle === "box" ? "active" : ""}
          >
            <BsFillGrid3X3GapFill />
          </button>

          <button
            onClick={() => dispatch({ type: "listStyle", listStyle: "list" })}
